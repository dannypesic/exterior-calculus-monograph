...
This does not mean that coordinates are meaningless, however. They are auxiliary tools used to describe a geometric system. The Earth may still have its geometry, but a pilot would not know how to fly from New York to London without a way to quantify the journey.
...
\[
\frac{\partial}{\partial x^{j'}} \left( \frac{\partial f}{\partial x^{i'}} \right) = \frac{\partial}{\partial x^{j'}} \left(
\frac{\partial x^k}{\partial x^{i'}}
